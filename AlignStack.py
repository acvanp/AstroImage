# -*- coding: utf-8 -*-
"""
Created on Sat Sep 16 19:01:05 2023
...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.resim1.setFixedSize(1200,600)
        self.outdict = {}
    ...
    def getClickedPosition(self, pos):
        ...
        self.outdict[self.filename] = {'x':pos.x(), 'y':pos.y()}
        with open('result.json', 'w') as fp: json.dump(self.outdict, fp)
