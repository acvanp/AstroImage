# -*- coding: utf-8 -*-
"""
Created on Fri Sep 15 07:10:28 2023
...
#folder = r'C:\Users\Owner\Desktop\Astrophotography\\Sept21\\'#r'C:\Users\Owner\Desktop\Astrophotography\\'
folder = os.getcwd() + '\\'

# Get the list of all files and directories
fns = os.listdir(folder)#os.listdir(folder)
#fns = [i for i in fns if i.startswith('a')] 
fns  = [i for i in fns if i.endswith('tiff')]

#fns = [folder + 'e' + str(i) + '.tiff' for i in range(12,16)]

cc=0
for fn in fns:
    lab = fn.split(".")[0]
    img = np.asarray(Image.open(folder + fn))
    im2array = img#[200:900, 650:1350]
    plt.imshow(im2array)
    cv2.imwrite(folder + lab + '_resaved_' + str(cc) +'_img.TIF', im2array)
    cv2.imshow("image", im2array)
    cc+=1
...
img1 = cv2.imread(folder + '/orion1/' + 'orion_sept15_2023' + str(0) +'_img.jpg')#cv2.imread("img1.png")
img2 = cv2.imread(folder + '/orion1/' + 'orion_sept15_2023' + str(1) +'_img.jpg')#cv2.imread("img2.png")
img3 = cv2.imread(folder + '/orion1/' + 'orion_sept15_2023' + str(2) +'_img.jpg')#cv2.imread("img3.png")
